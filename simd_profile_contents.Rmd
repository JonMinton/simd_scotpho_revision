...
Additional caveats in interpreting SIMD data are also described in the 'Limitations of SIMD' subsection of [this PHS website](https://www.isdscotland.org/Products-and-Services/GPD-Support/Deprivation/SIMD/)
...
Chart 2 shows the how the 15% most deprived datazones in Scotland are distributed across NHS Health boards. The slider at the bottom can be moved to show how the proportions vary by level of deprivation (e.g. 0.25 shows the share of datazones in the most deprived 25% of Health Boards). 
